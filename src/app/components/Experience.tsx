...
const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    period: "2024 - Present",
    description: [
      "Developed Blazor applications with SignalR and JavaScript interop",
      "Enhanced application security by centralizing secrets and credentials in Azure Key Vault",
      "Implemented distributed caching and intelligent cache invalidation strategies",
      "Provisioned CI/CD pipelines in Azure DevOps for multi-environment deployments",
      "Integrated open telemetry logs using Azure Application Insights and Azure Monitor",
    ],
    technologies: [
      "ASP.NET Core",
      "JavaScript",
  ...
  },
  {
    ...
    period: "2021 - 2024",
    description: [
      "Developed loan eligibility checkers for newcomers",
      "Built recipe and food discovery applications",
...
const skills = [
  ...
  },
  {
    name: "Backend",
    icon: Database,
    items: ["Node.js", "C#", ".NET", "PostgreSQL", "MongoDB", "Supabase"],
  },
  {
    name: "Tools",
    icon: Code,
